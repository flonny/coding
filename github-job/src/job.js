...
import ReactMarkdone from 'react-markdown'
    ...
    return <Card className="mb-3">
        <Card.Body>
            <div className="d-flex justify-content-between">
                <div>
                    <Card.Title>
                        {job.title} - <span className="text-muted fontweight-light">
                            {job.company}
                        </span>
                    </Card.Title>
                    ...
                    <div style={{ wordBreak: 'break-all' }}>
                        <ReactMarkdone source={job.how_to_apply} />
                    </div>
                </div>
            ...
            <Collapse in={open}>
                <div className="mt-4">
                    <ReactMarkdone source={job.description}/>
                </div>
            </Collapse>
        </Card.Body>
    </Card>
